...
import { Button } from "@/components/responsive/layout";
            ...
            <form onSubmit={handleLogin} className="space-y-5">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 h-12 text-base bg-slate-700/50 border-slate-600 text-white placeholder:text-slate-400"
                    required
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 pr-10 h-12 text-base bg-slate-700/50 border-slate-600 text-white placeholder:text-slate-400"
                    required
                  />
                  <button
                    type="button"
              ...
              <div className="space-y-2">
                {process.env.NEXT_PUBLIC_TURNSTILE_SITE_KEY ? (
                  ...
                  <div className="flex justify-center p-4 bg-yellow-900/50 border border-yellow-600 rounded-md">
              ...
              <div className="flex items-center">
                <input
                  ...
                  className="h-4 w-4 text-blue-500 focus:ring-blue-500 border-slate-600 rounded bg-slate-700/50"
                />
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <Button
                    ...
                    disabled={isLoading}
                    className="h-12 border-slate-600 hover:bg-slate-700 hover:text-white font-medium text-slate-300"
                  >
              ...
              <Button
                ...
                className="h-14 font-bold text-lg bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 shadow-lg transform transition-all duration-200 hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed text-white"
              >
                {isLoading ? (
                  <>
