      ...
      <SidebarLayout>
        <div className="flex items-center justify-center min-h-screen">
          <div className="text-center">
            ...
            <p className="text-slate-300 mb-4">Please sign in to view analytics.</p>
          </div>
        </div>
      </SidebarLayout>
    );
      ...
      <SidebarLayout>
        <div className="min-h-screen bg-slate-900 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-slate-300">Failed to load analytics data.</p>
          </div>
        </div>
      </SidebarLayout>
    );
    ...
    <div className="min-h-screen bg-slate-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex gap-4">
              <select
                ...
                className="px-3 py-2 border border-slate-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-slate-800 dark:border-slate-600 dark:text-white"
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          ...
          <Card className="">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-slate-300">Business Ideas</p>
                  <p className="text-3xl font-bold text-white">{formatNumber(stats.totalIdeas)}</p>
                </div>
          ...
          <AnimatedCard className="">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-slate-300">Investment Offers</p>
                  <p className="text-3xl font-bold text-white">{formatNumber(stats.totalOffers)}</p>
                </div>
          ...
          <AnimatedCard>
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-slate-300">Total Funding</p>
                  <p className="text-3xl font-bold text-white">{formatCurrency(stats.totalFunding)}</p>
                </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          ...
          <AnimatedCard>
            <CardHeader>
              ...
              <CardDescription className="text-white">Breakdown of creators vs investors</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card className="">
            <CardHeader>
              ...
              <CardDescription className="text-white">Most popular business categories</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <div className="grid lg:grid-cols-2 gap-6 mb-8">
          ...
          <Card className="">
            <CardHeader>
              <CardTitle className="text-white">Recent Activity ({timeRange})</CardTitle>
              <CardDescription className="text-white">Platform activity in the selected time period</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                <div className="flex items-center justify-between p-3 bg-blue-900/10 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm font-medium text-white">New Ideas</span>
                  </div>
                ...
                <div className="flex items-center justify-between p-3 bg-green-900/10 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm font-medium text-white">New Offers</span>
                  </div>
                ...
                <div className="flex items-center justify-between p-3 bg-purple-900/10 dark:bg-purple-900/20 rounded-lg border border-purple-200 dark:border-purple-800">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm font-medium text-white">New Matches</span>
                  </div>
          ...
          <Card className="">
            <CardHeader>
              ...
              <CardDescription className="text-white">Key performance indicators</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div>
                <div className="flex justify-between items-center mb-2">
                  <span className="text-sm font-medium text-white">Match Success Rate</span>
                  <span className="text-sm text-slate-300">
              ...
              <div>
                <div className="flex justify-between items-center mb-2">
                  <span className="text-sm font-medium text-white">Average Match Score</span>
                  <span className="text-sm text-slate-300">{stats?.averageMatchScore || 0}%</span>
                </div>
                <div className="w-full bg-slate-700 rounded-full h-3">
              ...
              <div>
                <div className="flex justify-between items-center mb-2">
                  <span className="text-sm font-medium text-white">User Engagement</span>
                  <span className="text-sm text-slate-300">
        ...
        <Card className="">
          <CardHeader>
            ...
            <CardDescription className="text-white">Platform growth over time</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid md:grid-cols-3 gap-4">
              <div className="text-center p-4 bg-gradient-to-br from-blue-900/10 to-blue-800/20 dark:from-blue-900/20 dark:to-blue-800/30 rounded-lg border border-blue-200 dark:border-blue-800">
                ...
                <div className="text-sm text-slate-300">User Growth</div>
              ...
              <div className="text-center p-4 bg-gradient-to-br from-green-900/10 to-green-800/20 dark:from-green-900/20 dark:to-green-800/30 rounded-lg border border-green-200 dark:border-green-800">
                ...
                <div className="text-sm text-slate-300">Ideas Submitted</div>
                <div className="text-xs text-slate-400 mt-1">vs last month</div>
              </div>
              <div className="text-center p-4 bg-gradient-to-br from-purple-900/10 to-purple-800/20 dark:from-purple-900/20 dark:to-purple-800/30 rounded-lg border border-purple-200 dark:border-purple-800">
                ...
                <div className="text-sm text-slate-300">Match Rate</div>
                <div className="text-xs text-slate-400 mt-1">vs last month</div>
              </div>
            </div>
          </CardContent>
